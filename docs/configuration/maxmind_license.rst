...
From the :xref:`2.16 release`, MailFly has supported using a license key to access the MaxMind IP lookup service.
...
Follow these steps to configure your MailFly instance to use the license key.
...
.. image:: images/MailFly-maxmind-account.png
  :width: 600
...
8. Go to MailFly > Settings > Configuration > System Settings > Miscellaneous Settings and enter the license key into the "IP lookup service authentication" **field in the format** ``AccountID:Licensekey``.

.. image:: images/MailFly-maxmind-license-key.png
  :width: 600
  :alt: Screenshot of MaxMind license key

9. Click ``Fetch IP Lookup Data Store``. This downloads the IP lookup database to your MailFly instance.
